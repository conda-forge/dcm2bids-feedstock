...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dcm2bids-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11979&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dcm2bids-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dcm2bids` can be installed with:

```
conda install dcm2bids
```

It is possible to list all of the versions of `dcm2bids` available on your platform with:
